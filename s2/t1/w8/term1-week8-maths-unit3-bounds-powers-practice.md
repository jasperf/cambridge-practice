...
## Section B: Powers in Compound Percentages
...
- A) The value of the house after 3 years
- B) The value of the house after 7 years
- C) How much the value has gone up by over 7 years
- D) The value after 7 years if it rose by 7% each year
...
## Section C: Bounds of Whole Numbers
...
## Section D: Bounds of Numbers with One Decimal Place
...
## Section E: Measurements & Mixed Bounds
...
- A) The length of a corridor, in cm
- B) The number of pages in a book
- C) The mass of a parcel, in grams
- D) The time a race took, in seconds
...
|---------|-------|-----------|-------|
| A | Powers of 10 | Q1–Q8 | 11 |
| B | Powers in Compound Percentages | Q9–Q14 | 8 |
