# Secondary 2 · Term 1 · Mathematics — Unit 3 Retest: Bounds & Significant Figures

**Stage 9 · Unit 3 (3.4) with significant figures**
**34 questions · 40 marks**

A retest on bounds only, written after the Unit 3 follow-up. It builds bounds up in small steps: rounding to significant figures, finding the unit of rounding, halving it, and then asking what kind of number was rounded. This document contains all questions from the interactive sheet in a printable format, plus extra written questions at the end. Students write their answers directly in their notebooks.

**Videos:** [Corbettmaths — Lower and Upper Bounds](https://www.youtube.com/watch?v=ebMrP74boHw) · [Significant figures videos (YouTube search)](https://www.youtube.com/results?search_query=corbettmaths+significant+figures)

---

## Section A: Rounding to Significant Figures (Step 0)
...
## Section B: Find the Unit of Rounding (Step 1)
...
## Section C: Measurements — Half a Unit Either Side (Steps 2 & 3)
...
*On the interactive sheet, a Bounds Explorer lets you type any rounded value, pick the accuracy and the kind of number, and drag an exact value along a number line to see what it rounds to.*
...
## Section D: Bounds with Significant Figures
...
## Section E: Which Kind of Number Was Rounded?
...
| What was rounded | It can be | Range | Upper bound |
|---|---|---|---|
| A **whole number** (a count: people, pages) | 15, 16, …, 24 | 15 ≤ x ≤ 24 | **24** — 25 rounds to 30 |
...
- A) A whole number, such as a number of people
- B) A measurement, such as a length in metres
- C) A number with one decimal place
- D) A number with two decimal places
...
**No method box here.** Try these like a real test: for each one, write down Step 0 (what kind of number?), Step 1 (the unit), Step 2 (half of it) before you answer.
...
*These four questions are not on the interactive sheet and are not auto-marked. Show all working in your notebook, and check your answers with your teacher.*

**Q35** (3 marks)
Copy and complete the table. Each row is rounded to the nearest whole number and gives 9.

| What was rounded | Lower bound | Upper bound | Range as an inequality |
|---|---|---|---|
| A whole number | | | |
...
**Q36** (3 marks)
A student says: "A length of 3400 m, correct to 2 significant figures, has bounds 3399.5 and 3400.5."
a) Explain the mistake.
b) Write the correct range as an inequality.

**Q37** (3 marks)
For each inequality, write the rounded value and the accuracy it was rounded to (for example "nearest 10").
a) 55 ≤ x < 65
b) 15.5 ≤ x < 16.5
c) 1550 ≤ x < 1650

**Q38** (3 marks)
Read 2.35 ≤ t < 2.45 out loud in words. Then give one value of *t* that fits, and one value very close to it that does not fit, and explain why.
...
|---------|-------|-----------|-------|
| A | Rounding to Significant Figures | Q1–Q6 | 6 |
| B | Find the Unit of Rounding | Q7–Q11 | 5 |
| C | Measurements — Half a Unit | Q12–Q17 | 6 |
| D | Bounds with Significant Figures | Q18–Q22 | 7 |
| E | Which Kind of Number Was Rounded? | Q23–Q28 | 8 |
| F | Mini Test | Q29–Q34 | 8 |
| **Interactive total** | | **34** | **40** |
| Written Questions | Q35–Q38 (printable only) | Q35–Q38 | 12 |
...
*Note: Q1–Q34 match the interactive sheet's questions exactly, so they can be self-checked there. Q35–Q38 are extra written questions for practice and are not auto-marked.*

*Source: Interactive version at `s2/t1/w8/term1-week8-maths-unit3-bounds-sigfigs-retest.html`*
