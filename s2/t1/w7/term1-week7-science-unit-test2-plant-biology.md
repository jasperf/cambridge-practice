...
**Scope of the test:** what photosynthesis is and its summary word equation, chloroplasts and chlorophyll, what a plant does with the glucose it makes, energy stores in plants, magnesium and nitrate, fertilisers and yield, and the two class investigations (light intensity, and testing a leaf for starch).

---

## Part 1: Photosynthesis

**Key ideas:** **Photosynthesis** is the process by which plants use **sunlight**, **water** and **carbon dioxide** to make **oxygen** and energy in the form of a sugar, **glucose**. Plants are called **producers** because they produce their own food. Water comes from the **soil** through the roots; carbon dioxide comes from the **air**. Oxygen is released into the atmosphere and the glucose is used for biomass and energy.

**Summary word equation:**

> carbon dioxide + water → glucose + oxygen
> *(light energy and chlorophyll are written above the arrow — they are not reactants)*
...
- A) It provides energy, stored as chemical energy in nutrients, for almost all other organisms
- B) It removes all bacteria from the soil
- C) It provides the oxygen in the Earth's atmosphere
- D) It makes the minerals that plants absorb through their roots

---

## Part 2: Chlorophyll & What Glucose Is Used For

**Key ideas:** A **chloroplast** is an organelle found only in plant cells — it is *where* photosynthesis happens. **Chlorophyll** is the green *pigment* inside the chloroplast that captures energy from sunlight. Plants use their glucose for **respiration**, **making cellulose** for cell walls, **making starch stores**, **making proteins** for growth and repair, and **making fats and oils** for storage. Extra carbohydrate is stored as **starch inside the chloroplasts**. Roots and tubers store starch/glucose; nuts and seeds store fats and oils.
...
- B) The chloroplast is the organelle where photosynthesis happens; chlorophyll is the green pigment inside it that absorbs sunlight
- C) Chlorophyll is the organelle; the chloroplast is the green pigment inside it
- D) The chloroplast is found in animal cells and chlorophyll in plant cells

**Q12** (1 mark)
Name the green pigment that captures energy from sunlight.
...
- A) Nothing — the statement is completely correct
- B) Plants do not respire at all, only animals do
- C) Plants do respire, but without sunlight they cannot photosynthesise, so they stop making glucose
- D) Plants only respire at night and never photosynthesise
...
**Q15** (3 marks)
Tick **all four** things a plant uses the glucose made in photosynthesis for.
- A) Respiration
- B) Making cellulose for cell walls
- C) Making light energy to shine on the leaf
- D) Making starch stores
- E) Making fats and oils for storage
- F) Making the magnesium it needs for chlorophyll
...
- A) In the cell wall
- B) Inside the chloroplasts
- C) In the nucleus
- D) In the soil around the roots
...
## Part 3: Minerals & Plant Growth

**Key ideas:** **Minerals** are water-soluble substances that plants absorb from the **soil through their roots**. Plants need only small quantities, but if the soil runs short the plant cannot grow to its full potential. **Fertilisers** contain minerals, which is why adding them raises the **yield** — the quantity of crop harvested.

| Mineral | What it is needed for | What a shortage looks like |
|---------|----------------------|----------------------------|
| **Magnesium (Mg)** | Making chlorophyll | Leaves look **yellow** (or brown) instead of green; less light absorbed, so less photosynthesis |
| **Nitrate** (contains nitrogen) | Converting carbohydrates into **proteins**, which make new cells; also needed for chlorophyll | Plant **grows slowly and stays small**; leaves are **pale** and may die |
...
- B) Yellow (or brown) instead of green
- C) Bright blue
- D) Completely unchanged

**Q23** (2 marks)
Explain the *chain*: why does a magnesium-deficient plant grow badly?
- A) Because magnesium is the main gas used up in photosynthesis
- B) Because magnesium is what plants convert into proteins for new cells
- C) Without magnesium it cannot make enough chlorophyll, so it absorbs less energy from sunlight and photosynthesises less than it should
- D) Because magnesium is what keeps the soil moist around the roots
...
- A) It grows very tall, very quickly
- B) Its leaves turn a much darker green
- C) It grows slowly and stays small, and its leaves are pale and may die
- D) It stops absorbing water through its roots
...
## Part 4: Think Like a Scientist — Investigations

**Key ideas:** **(1) Light intensity and the rate of photosynthesis** — pondweed under water gives off bubbles of oxygen; count the bubbles per minute as the lamp is moved closer or further away. Plot bubbles per minute against light intensity: the line rises, then levels off. **(2) Testing a leaf for starch** — a leaf that has been photosynthesising has stored starch, which turns iodine solution **blue-black**.
...
**Q32** (1 mark)
Which gas is inside those bubbles?
...
- A) The distance from the lamp to the pondweed
- B) The number of bubbles counted
- C) The temperature of the water
- D) The brightness reaching the pondweed
...
- A) Because starch is a reactant that photosynthesis uses up, so less starch means more photosynthesis
- B) Because chlorophyll turns into starch whenever the leaf is left in the dark
- C) Because the glucose made in photosynthesis is stored as starch in the leaf, so starch being present means photosynthesis has happened
- D) Because starch is absorbed from the soil, but only while the leaf is in the light

---

## Part 5: Extended Answer
...
**Q39** (3 marks)
Write the summary word equation for photosynthesis, then explain why light energy is written *above* the arrow rather than on the left-hand side with the reactants.

**Q40** (4 marks)
Describe the difference between a chloroplast and chlorophyll, and explain what each one does during photosynthesis.

**Q41** (4 marks)
Two fields of wheat are growing side by side. In field A the leaves are yellow. In field B the plants are small and stunted with pale leaves. Suggest which mineral each field is short of, and explain how that shortage produces the symptom you can see.

**Q42** (3 marks)
A farmer is deciding how much fertiliser to spread on a large field. Explain why testing the soil in different parts of the field is better than spreading the same amount everywhere. Give one benefit for the farmer and one for the environment.

**Q43** (4 marks)
Plan the pondweed investigation. State the independent variable, the dependent variable, and **two** control variables, and describe how you would take your measurements so the results are reliable.

**Q44** (4 marks)
A plant is left in a dark cupboard for 48 hours before a leaf is tested for starch. The test is negative — the iodine does not turn blue-black. Explain this result, and explain why the plant is de-starched in this way *before* an experiment on photosynthesis begins.
...
*Note: Q1–Q38 match the interactive sheet's questions s1–s38 exactly, so they can be self-checked there. Q39–Q44 are extra extended-answer questions for written practice and are not auto-marked.*

*Source: Interactive version at `s2/t1/w7/term1-week7-science-unit-test2-plant-biology.html`*
